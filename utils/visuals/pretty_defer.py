...
async def pretty_defer(
    ...
    content: str = "Please wait while Arceus thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Arceus loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Arceus.
    - Always ephemeral.
    - Uses Arceus's error emoji.
